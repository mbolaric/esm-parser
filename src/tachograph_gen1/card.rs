...
use crate::{
    ...
    tacho::{self, CardChipIdentification, CardDataFile, CardFileID, CardIccIdentification, CardItem},
};
...
impl Card {
    ...
    pub fn parse(card_data_files: &HashMap<CardFileID, CardItem<CardDataFile>>) -> Result<Card> {

...
use crate::gen2::SealDataCard;
use crate::tacho::{CalibrationPurpose, ExtendedSerialNumber, OdometerShort, TimeReal, VehicleRegistrationIdentification};
...
#[cfg_attr(feature = "typescript", ts(rename = "Gen2WorkshopCardCalibrationRecord"))]
pub struct WorkshopCardCalibrationRecord {
    ...
    #[serde(rename = "sensorGnssSerialNumber")]
    pub sensor_gnss_serial_number: ExtendedSerialNumber,
    #[serde(rename = "rcmSerialNumber")]
    pub rcm_serial_number: ExtendedSerialNumber,
    #[serde(rename = "sealDataCard")]
...
impl Readable<WorkshopCardCalibrationRecord> for WorkshopCardCalibrationRecord {
    fn read<R: binary_data::ReadBytes + binary_data::BinSeek>(reader: &mut R) -> crate::Result<WorkshopCardCalibrationRecord> {
        ...
        let sensor_gnss_serial_number = ExtendedSerialNumber::read(reader)?;
        let rcm_serial_number = ExtendedSerialNumber::read(reader)?;
        let seal_data_card = SealDataCard::read(reader)?;
